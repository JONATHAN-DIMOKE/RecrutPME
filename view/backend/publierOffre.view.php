                                    ...
                                    <div class="col-md-12">
                                        <div>
                                            <form>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <label for="exampleInputEmail1">Date debut offre</label>
                                                        <input type="date"  class="form-control" placeholder="Date de debut" >
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <label for="exampleInputEmail1">Date Fin offre</label>
                                                        <input type="date"  class="form-control" placeholder="Date de debut" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <label for="exampleInputEmail1">Description du poste ( FICHIER )</label>
