                                ...
                                <div class="row" style="padding-top: 10px">
                                    <div class="col-md-12">
                                        <table class="table table-responsive" id="myTable">
                                            ...
                                            <tr>
                                                <td>N°</td>
                                                <th scope="col" id="nomComplet">Description</th>
                                            ...
                                            foreach ($listOffre as $offre){
                                                ...
                                                echo "<td><a class='btn btn-primary' href='dispatcher.php?action=telechargerFileDescripOffre&documentOffre=".$offre['fileOffre']."'>Download</a></td>";
                                                echo "<td><a href='dispatcher.php?action=showPostulerOffre&idOffre=".$offre['id']."&titreOffre=".$offre['titreExpression']."' class='btn btn-warning'>Postuler</a></td>";
                                                $compteur++;
                                                echo "</tr>";
                                            }
                                            ?>
