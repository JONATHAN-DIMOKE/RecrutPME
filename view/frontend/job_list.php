        ...
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-sm-6 e-left">
                            ...
                            <div class="e-desc">
                                <h6><a href="job_single.php">Lead Android Developer </a></h6>
                        ...
                        <div class="col-sm-6 e-left">
                            ...
                            <div class="e-desc">
                                <h6><a href="job_single.php">Senior Front - End Engineer </a></h6>
                    ...
                    <div class="row my-4">
                        <div class="col-sm-6 e-left">
                            ...
                            <div class="e-desc">
                                <h6><a href="job_single.php">Senior Java Developer
                                    </a></h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 e-left">
                            <a href="#"><img src="images/b3.jpg" alt="" class="img-fluid"></a>
                            <div class="e-desc">
                                <h6><a href="job_single.php">Web Designer </a></h6>
            ...
            <div class="d-flex justify-content-center">
                <ul class="pagination pt-4">
                    <li><a href="#"><em class="fa fa-angle-left"></em></a></li>
                    <li class="active"><a href="#" class="text-white bg-theme">1</a></li>
                    <li><a href="#">2</a></li>
                    <li><a href="#">3</a></li>
                    <li> <a href="#" aria-label="Next"><em class="fa fa-angle-right"></em></a>
                    </li>
                </ul>
            </div>
        </div>
