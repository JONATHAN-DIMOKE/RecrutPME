...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb d-flex justify-content-center bg-theme">
            ...
            <li class="breadcrumb-item">
                <a href="job_list.php" class="text-white">Job List</a>
            </li>
                ...
                <div class="col-lg-9  mx-auto" id="job-desc">
                    ...
                    <div class="job-role">
                        ...
                        <div class=" job-desc-w3ls">
                            <ul class="mt-3">
                                <li>
                                    <em class="fa fa-angle-right mr-3"></em>Cras justo odio</li>
                                <li>
                                    <em class="fa fa-angle-right mr-3"></em>Dapibus ac facilisis in</li>
                                <li>
                                    <em class="fa fa-angle-right mr-3"></em>Morbi leo risus</li>
                                <li>
                                    <em class="fa fa-angle-right mr-3"></em>Porta ac consectetur ac</li>
                                <li>
                                    <em class="fa fa-angle-right  mr-3"></em>Vestibulum at eros</li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- //job description -->
    <!-- Footer -->
    <?php require "partial/footerFrontend.view.php"?>
    <!-- /Footer -->
