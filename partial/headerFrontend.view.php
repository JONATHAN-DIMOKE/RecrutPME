            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="ml-lg-5 navbar-nav mr-lg-auto">
                    ...
                    <li class="nav-item  mr-lg-4 mt-lg-0 mt-sm-4 mt-3">
                        <a href="dispatcher.php?action=about">about</a>
                    </li>
                    <li class="nav-item dropdown mr-lg-4 my-lg-0 my-sm-4 my-3">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="dispatcher.php?action=job_list">Job List</a>
                            <a href="dispatcher.php?action=job_single">Job Single</a>
                        </div>
                    </li>
                    <li class="nav-item mr-lg-4 my-lg-0 mb-sm-4 mb-3">
                        <a href="dispatcher.php?action=contact">contact</a>
                    </li>
                </ul>
